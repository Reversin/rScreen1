package com.example.rscreen1.adapter
...
import com.example.rscreen1.R
import com.example.rscreen1.data.UserData
import com.example.rscreen1.adapter.AddParagraph.AddP as AddP1

class AddParagraph(val c: Context, val userList: ArrayList<UserData>) :
    RecyclerView.Adapter<AddP1>() {

    inner class AddP(val v: View) : RecyclerView.ViewHolder(v) {
        var name: TextView
        var mbNum: TextView
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AddP1 {
        val inflater = LayoutInflater.from(parent.context)
        val v = inflater.inflate(R.layout.list_item, parent, false)
        return AddP(v)
    }

    override fun onBindViewHolder(holder: AddP1, position: Int) {
